 ...
 * methods in the "Tracing API methods" section, or optionally the subset of
...
export class Tracer {
     ...
     *         references: [
     *             Tracing.followsFrom(parent.context())
     *         ],
     *     });
     *
     ...
     * `format.
     *
     * Tracing defines a common set of `format` values (see
     ...
     *     // Incorporate the textCarrier into the outbound HTTP request header map
